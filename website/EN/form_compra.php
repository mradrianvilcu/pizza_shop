...
<div id=container>
    ...
    <div class="divFila">
            <label class="textoFila" for="name">Name:</label>
    ...
    <div class="divFila">
            <label class="textoFila" for="postcode">Postcode:</label>
            ...
            ">SHOW DELIVERY CHARGE</p>
            <p id="dCInfo">Postcode out of delivery area.</p>
    </div>
    <div class="divFila">
    ...
    <div class="divFila">
            <label class="textoFila" for="tacamuri">Cutlery:</label>
    ...
    <div class="divFila">
            <label class="textoFila" for="payment">Payment:</label>
    ...
    <div class="divFila">
            <label class="textoFila" for="comments">Comments for kitchen/delivery:</label>
            <textarea  rows="4" autocomplete="off" name="comments" id="comments"></textarea>
            <p id="minimum_payment">Minimum order for delivery is £17 after all discounts.</p>
    </div>
    <div>
