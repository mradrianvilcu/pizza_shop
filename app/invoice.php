...
<div style="width:100%; height:100%; display:flex; flex-direction:column; justify-content:center; align-items:center;">
    <div id="invoice" style=" width:300px;  border: 1px solid; padding:1rem;">
        <?php
        ...
        if ($orderConcreta->num_rows > 0) {
            ...
            <?php
             $postcodeRep = $rowOrderConcreta['postcode'];
             $repeticiones= 0;
            ...
            <div style="margin-bottom:0.5rem;text-align:left">Address: <?php echo $rowOrderConcreta['address']; ?></div>
            <div class="linea">-------------------------------------------------------</div>
            <!-- tabla compra -->
            <div>
       ...
       <?php
            ...
            <div class="linea">-------------------------------------------------------</div>
            <div class="linea">Ordered x times</div>
            <div class="linea">F Popescu</div>
            <div class="linea">Sort Code:</div>
            <div class="linea">Account Number:</div>
