...
$path_kitchen_invoice="C:/xampp/htdocs/unitypos/myproject/last_kitchen_invoice_deleted.txt";
...
$sqlOrderConcreta = "SELECT * FROM orders WHERE id='$id_order' AND deleted='0'";
        ...
        if ($orderConcreta->num_rows > 0) {
            $rowOrderConcreta = $orderConcreta->fetch_assoc();
                                         ...
                                         shell_exec("echo." . " >> " . $path_kitchen_invoice);
                                         shell_exec("echo " . "----------------------------" . " >> " . $path_kitchen_invoice);
                                         shell_exec("echo DELETED >> " . $path_kitchen_invoice);
     ...
     if($comparador1 != $comparador2){ 
         ...
         //cambiamos el valor de la tabla a borrado
         $sqlImpreso = "UPDATE orders SET deleted='1' WHERE pers_id='$id_personalizado'";
