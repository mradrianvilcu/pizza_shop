...
<a id="btnExitViewOrder" href="orders.php">&#10006;</a>

<?php
if(isset($_POST['id_order']) || (isset($_GET['id_order']))){ 
...
<?php }
    ...
    ?>
        ...
        if ($orderConcreta->num_rows > 0) {
            ...
            if($id_order < 100){
                $aux_id_order = "0" . (intval($id_order));
            }else{
                $aux_id_order = substr($id_order, -3);   
            }
            ?>
    ...
    <div id="invoice" style="  border: 1px solid; padding:1rem;">
            ...
            <div style="margin-bottom:1rem;text-align:center;"><b># <?php echo $aux_id_order; ?> </b></div>
